...
public class SendEmail 
	{
		...
		public void sendMail(String mailServer, String from, String[] to, String subject, String messageBody) throws MessagingException, AddressException, IOException
		{
			boolean debug = false;
			...
			try
			{
	         ...
	         //X-Priority values are generally numbers like 1 (for highest priority), 3 (normal) and 5 (lowest).
	            ...
	            attachment.attachFile(System.getProperty("user.dir") + "\\reports\\" + ExtentManager.extentfileName);
	            MimeBodyPart attachmentlog = new MimeBodyPart();
	            attachmentlog.attachFile(System.getProperty("user.dir") + "\\src\\test\\resources\\logs\\Selenium.logs");
