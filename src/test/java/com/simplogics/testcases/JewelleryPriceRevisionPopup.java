...
public class JewelleryPriceRevisionPopup extends Testbase {
	
	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void jewelleryPriceRevisionPopup(Hashtable<String, String>data) throws InterruptedException,AWTException{
		
		if (!(TestUtil.isTestRunnable("jewelleryPriceRevisionPopup", excel))) {

			throw new SkipException("Skipping the test " + "jewelleryPriceRevisionPopup".toUpperCase() + "as the Run mode is NO");
		}
