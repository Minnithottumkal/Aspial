...
public class WatchPriceRevisionPopup extends Testbase{
	
	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void watchPriceRevisionPopup(Hashtable<String, String> data) throws InterruptedException, AWTException {

		if (!(TestUtil.isTestRunnable("WatchPriceRevisionPopup", excel))) {

			throw new SkipException(
					"Skipping the test " + "WatchPriceRevisionPopup".toUpperCase() + "as the Run mode is NO");
		}
