...
public class WatchPriceRecordingHistory extends Testbase{
	
	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void watchPriceRecordingHistory(Hashtable<String, String> data)
			throws InterruptedException, AWTException {

		if (!(TestUtil.isTestRunnable("WatchPriceRecordingHistory", excel))) {
			ExtentManager.logger.log(Status.SKIP, "Skipped Type is: " + data.get("Type"));
			throw new SkipException(
					"Skipping the test " + "WatchPriceRecordingHistory".toUpperCase() + "as the Run mode is NO");
		}
