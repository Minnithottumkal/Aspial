...
public class AddInvoiceBagDetails extends Testbase {
	
	public static int i = 1;
	
	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void addInvoiceBagDetails(Hashtable<String, String>data) throws InterruptedException, AWTException {
		
		if (!(TestUtil.isTestRunnable("addInvoiceBagDetails", excel))) {

			throw new SkipException(
					"Skipping the test " + "addInvoiceBagDetails".toUpperCase() + "as the Run mode is NO");
		}
