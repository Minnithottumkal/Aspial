...
public class CreateBagBulkManual extends Testbase{
	
	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void createBagBulkManual(Hashtable<String, String>data) throws InterruptedException, AWTException {
		
		if (!(TestUtil.isTestRunnable("CreateBagBulkManual", excel))) {

			throw new SkipException(
					"Skipping the test " + "CreateBagBulkManual".toUpperCase() + "as the Run mode is NO");
		}
		...
		click("Newbulk_CSS");
		MywaitvisibilityOfElementLocated("bagBulk_XPATH");
		click("bagBulk_XPATH");
