...
public class ItemizationInvoiceJewellery extends Testbase {
	...
	public void ItemizationinvoiceJewellery(Hashtable<String, String> data) throws InterruptedException, AWTException {

		if (!(TestUtil.isTestRunnable("ItemizationinvoiceJewellery", excel))) {

			throw new SkipException(
					"Skipping the test " + "ItemizationinvoiceJewellery".toUpperCase() + "as the Run mode is NO");
		}
