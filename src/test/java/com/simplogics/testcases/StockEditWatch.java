...
public class StockEditWatch extends Testbase{
	
public void stockEditWatch(Hashtable<String, String>data) throws  InterruptedException, AWTException {
		
		if (!(TestUtil.isTestRunnable("StockEditWatch", excel))) {

			throw new SkipException(
					"Skipping the test " + "StockEditWatch".toUpperCase() + "as the Run mode is NO");
		}
