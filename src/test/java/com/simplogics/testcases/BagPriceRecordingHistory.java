...
public class BagPriceRecordingHistory extends Testbase{
	
	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void bagPriceRecordingHistory(Hashtable<String, String> data)
			throws InterruptedException, AWTException {

		if (!(TestUtil.isTestRunnable("BagPriceRecordingHistory", excel))) {
			ExtentManager.logger.log(Status.SKIP, "Skipped Type is: " + data.get("Type"));
			throw new SkipException(
					"Skipping the test " + "BagPriceRecordingHistory".toUpperCase() + "as the Run mode is NO");
		}
