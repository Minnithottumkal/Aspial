...
public class GoldPriceRecordingHistory extends Testbase{
	
	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void goldPriceRecordingHistory(Hashtable<String, String>data)throws InterruptedException,AWTException{
		
		if (!(TestUtil.isTestRunnable("goldPriceRecordingHistory", excel))) {
			ExtentManager.logger.log(Status.SKIP, "Skipped Type is: " + data.get("Type"));
			throw new SkipException(
					"Skipping the test " + "goldPriceRecordingHistory".toUpperCase() + "as the Run mode is NO");
		}
