...
public class BagPriceRevisionPopup extends Testbase{
	
	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void bagPriceRevisionPopup(Hashtable<String, String> data) throws InterruptedException, AWTException {

		if (!(TestUtil.isTestRunnable("BagPriceRevisionPopup", excel))) {

			throw new SkipException(
					"Skipping the test " + "BagPriceRevisionPopup".toUpperCase() + "as the Run mode is NO");
		}
