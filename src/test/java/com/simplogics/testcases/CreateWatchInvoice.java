...
public class CreateWatchInvoice extends Testbase{
	
	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void createWatchInvoice(Hashtable<String, String>data) throws InterruptedException,AWTException {
		
		if (!(TestUtil.isTestRunnable("CreateWatchInvoice", excel))) {

			throw new SkipException(
					"Skipping the test " + "CreateWatchInvoice".toUpperCase() + "as the Run mode is NO");
		}
		...
		MywaitpresenceOfElementLocated("watchBtn_XPATH");
		click("watchBtn_XPATH");
