...
public class AddWatchBulkDetails extends Testbase{
	
	public int i =0;
	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void addWatchBulkDetails(Hashtable<String, String> data) throws InterruptedException, AWTException {
		
		if (!(TestUtil.isTestRunnable("AddWatchBulkDetails", excel))) {

			throw new SkipException(
					"Skipping the test " + "AddWatchBulkDetails".toUpperCase() + "as the Run mode is NO");
		}
