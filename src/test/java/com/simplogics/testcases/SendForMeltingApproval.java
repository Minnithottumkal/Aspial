...
public class SendForMeltingApproval extends Testbase{
	
	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void sendForMeltingApproval(Hashtable<String, String>data) throws InterruptedException, AWTException {
		

		if (!(TestUtil.isTestRunnable("sendForMeltingApproval", excel))) {

			throw new SkipException(
					"Skipping the test " + "sendForMeltingApproval".toUpperCase() + "as the Run mode is NO");
		}
