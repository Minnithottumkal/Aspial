...
public class ItemizationInvoiceWatch extends Testbase {
	...
	public void itemizationInvoiceWatch(Hashtable<String, String>data) throws InterruptedException,AWTException {
		
		if (!(TestUtil.isTestRunnable("ItemizationInvoiceWatch", excel))) {

			throw new SkipException(
					"Skipping the test " + "itemizationInvoiceWatch".toUpperCase() + "as the Run mode is NO");
		}
