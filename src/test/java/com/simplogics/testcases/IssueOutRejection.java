...
public class IssueOutRejection extends Testbase {
	
	@Test(dataProviderClass = TestUtil.class, dataProvider = "dp")
	public void issueOutRejection(Hashtable<String, String>data)throws InterruptedException, AWTException {
		
		if (!(TestUtil.isTestRunnable("issueOutRejection", excel))) {

			throw new SkipException(
					"Skipping the test " + "issueOutRejection".toUpperCase() + "as the Run mode is NO");
		}
