...
public class AddInvoiceGoldDetails  extends Testbase {
	
	public static int i = 1;
	
	public void AddinvoiceGoldDetails(Hashtable<String, String> data) throws InterruptedException, AWTException {
		if (!(TestUtil.isTestRunnable("AddinvoiceGoldDetails", excel))) {

			throw new SkipException(
					"Skipping the test " + "AddinvoiceGoldDetails".toUpperCase() + "as the Run mode is NO");
		}
